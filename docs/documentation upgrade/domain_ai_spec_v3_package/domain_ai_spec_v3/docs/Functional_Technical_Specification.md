...
> **Normative reference:** This specification is grounded in the architectural baseline defined in:
> - **Architecture Strategy & Conceptual Model — Domain‑Specific AI Code Orchestrator** (`docs/Architecture_Strategy_Domain_Specific_AI_Code_Orchestrator.md`).
> 
> Where a conflict exists, the **Strategy document defines intent and boundaries**, while this FTS defines **functional/technical requirements and contracts**.
