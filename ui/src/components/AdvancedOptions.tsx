...
export function AdvancedOptions({
    ...
    return (
        <div className="w-full mt-2 border-t border-border/50 pt-2">
            ...
            {isOpen && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-3 bg-muted/20 rounded-lg border border-border/50 animate-in fade-in slide-in-from-top-2">
                    {/* Budget Limit */}
                    <div className="space-y-1.5">
                        ...
                        <input
                            ...
                            className="w-full px-2 py-1.5 text-xs bg-background border border-border rounded focus:ring-1 focus:ring-primary outline-none"
                        />
                    </div>
